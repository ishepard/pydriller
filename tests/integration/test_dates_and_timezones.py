...
def test_one_timezone():
    lc = list(
        Repository('test-repos/git-2/', single='29e929fbc5dc6a2e9c620069b24e2a143af4285f').traverse_commits())
...
def test_between_dates_reversed():
    lc = list(
        Repository('test-repos/git-4/', single='375de7a8275ecdc0b28dc8de2568f47241f443e9').traverse_commits())
