...
test_data = [
   ...
   ('https://github.com/ishepard/pydriller', 'pydriller/repository_mining.py', None, '5a1a2b89c53a115e8087408469da04a7156ad808', float(12/21))
]
...
def test(path_to_repo, filepath, from_commit, to_commit, expected):
    metric = OwnersContributedLines(path_to_repo=path_to_repo,
                                    filepath=filepath,
